...
export function RiskBurnDown({ critical, open, className, onPlanSprint }: Props) {
  ...
  const hoverBaseline = hoverDay == null ? null : baseline[hoverDay];
  const hoverPlanned = hoverDay == null ? null : planned[hoverDay];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_290px] gap-5 lg:gap-6 items-stretch">
          ...
          <div className="min-w-0 flex flex-col h-full">
            ...
            <rect
              ...
              fill="url(#bd-breach)"
            />
            {/* axis lines — Y (left) and X (bottom) */}
            <line
              x1={PAD_L}
              x2={PAD_L}
              y1={PAD_T}
            ...
            {hoverDay != null && hoverBaseline && hoverPlanned && (
              ...
              >
                ...
                <div className="mt-1 grid gap-0.5 font-mono tabular-nums text-slate-700">
                  ...
                  <span><span className="text-slate-500">Breach</span> {breachAt}</span>
                </div>
              </div>
            )}
            </div>
