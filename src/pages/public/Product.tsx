        ...
        <div className="bg-slate-50 dark:bg-[#030303] text-slate-600 dark:text-slate-300 font-sans antialiased selection:bg-cyan-500/30 selection:text-white min-h-screen transition-colors duration-500">
            ...
            <section className="relative pt-48 pb-32 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
                ...
                <div className="relative z-10 max-w-5xl mx-auto">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl border border-indigo-500/20 dark:border-cyan-500/20 bg-white/50 dark:bg-slate-900/50 backdrop-blur-md text-indigo-600 dark:text-cyan-400 text-[10px] font-black uppercase tracking-[0.2em] mb-10 shadow-xl shadow-indigo-500/5"
                    >
            ...
            <div className="max-w-6xl mx-auto px-6 mb-32 relative z-10">
                <motion.div 
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-10 rounded-[3rem] bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-white/5 shadow-2xl dark:shadow-none backdrop-blur-xl transition-all duration-500 hover:border-indigo-500/20 dark:hover:border-cyan-500/20"
                >
                    {[
                        ...
                        <div key={i} className="flex flex-col items-center justify-center text-center p-6 rounded-[2.5rem] hover:bg-slate-50 dark:hover:bg-white/5 transition-all duration-500 group">
                            <div className={`w-14 h-14 rounded-2xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-inner`}>
            ...
            <section className="py-32 px-6 bg-slate-50 dark:bg-slate-900/20 border-y border-slate-200 dark:border-white/5 relative transition-colors duration-500 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    <div className="flex justify-center mb-20">
                        <div className="inline-flex gap-2 p-2 bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-white/5 rounded-3xl backdrop-blur-xl shadow-2xl dark:shadow-none">
                            {productTabs.map(t => (
                                <button
                                    key={t.id}
                                    onClick={() => setActiveTab(t.id)}
                                    className={`px-8 py-4 rounded-2xl text-sm font-black transition-all duration-500 tracking-widest uppercase ${activeTab === t.id
                        ...
                        >
                            {tab.features.map((f, i) => (
                                <motion.div
                                    key={f.title}
                                    variants={fadeInUp}
                                    className={`group relative bg-white dark:bg-slate-900/40 border border-slate-200 dark:${tab.border} rounded-[2.5rem] p-10 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/10 dark:hover:shadow-cyan-500/10`}
                                >
                                    <div className={`absolute inset-0 rounded-[2.5rem] bg-gradient-to-br ${tab.theme} opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none`} />

                                    <div className="relative z-10">
                                        <div className={`w-16 h-16 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/10 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-inner`}>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="space-y-48">
                        ...
                        <div className="grid lg:grid-cols-2 gap-24 items-center">
                            ...
                            >
                                <div className="p-4 w-fit rounded-2xl bg-indigo-500/10 dark:bg-cyan-500/10 border border-indigo-500/20 dark:border-cyan-500/20 shadow-xl shadow-indigo-500/5">
                            ...
                            >
                                ...
                                <div className="relative rounded-[3rem] bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/5 p-12 shadow-2xl aspect-square flex flex-col items-center justify-center overflow-hidden transition-all duration-700 backdrop-blur-xl group-hover:scale-[1.02]">
                        ...
                        <div className="grid lg:grid-cols-2 gap-24 items-center">
                            ...
                            >
                                <div className="p-4 w-fit rounded-2xl bg-teal-500/10 border border-teal-500/20 shadow-xl shadow-teal-500/5">
            ...
            <section className="py-48 px-6">
                <div className="max-w-6xl mx-auto">
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="p-16 md:p-24 rounded-[4rem] bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 border border-white/10 relative overflow-hidden shadow-2xl"
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            <motion.div 
                                ...
                                className="w-24 h-24 rounded-3xl bg-cyan-500 border border-cyan-300 flex items-center justify-center mb-12 shadow-[0_0_50px_rgba(34,211,238,0.3)]"
                            >
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                                {aiFeatures.map((f, i) => (
                                    <motion.div 
                                        key={i} 
                                        whileHover={{ y: -10 }}
                                        className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md group hover:bg-white/10 hover:border-cyan-500/30 transition-all duration-500 shadow-xl"
                                    >
            ...
            <section className="py-32 px-6 bg-slate-950 border-t border-white/5">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-12">
                    {[
                        ...
                        >
                            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 shrink-0 group-hover:bg-cyan-500/10 group-hover:border-cyan-500/20 transition-all duration-500">
            ...
            <section className="py-64 px-6 relative overflow-hidden bg-slate-950">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <motion.div
                        ...
                        transition={{ delay: 0.2 }}
                    >
                        <Link to="/login" className="group inline-flex items-center gap-4 px-12 py-6 text-xl font-black bg-cyan-500 text-slate-950 rounded-2xl hover:bg-white hover:scale-105 transition-all duration-500 shadow-[0_0_60px_rgba(34,211,238,0.4)]">
