                                    ...
                                    return (
                                        <div key={item.id} className="p-4 hover:bg-slate-50 transition-colors flex flex-col md:flex-row gap-4 border border-transparent hover:border-slate-100 rounded-lg m-1">
                                            <div className="flex-1 space-y-3">
                                                <div className="flex items-center gap-3">
                                                    <span className="px-2 py-0.5 rounded text-[10px] font-mono font-medium tracking-wide uppercase" style={{ backgroundColor: `${dom?.color}15`, color: dom?.color, border: `1px solid ${dom?.color}30` }}>
                                                        {dom?.abbr}
                                                    </span>
                                            ...
                                            <div className="md:w-64 shrink-0 mt-2 md:mt-0 flex flex-col justify-between">
                                                <div>
                                                    <p className="text-[10px] font-mono font-medium text-slate-500 uppercase tracking-wide mb-1">Trigger</p>
