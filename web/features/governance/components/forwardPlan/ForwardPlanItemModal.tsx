            ...
            {sortedBodies.length === 0 ? (
              ...
              <div className="overflow-hidden rounded-lg border border-slate-200">
                <table className="w-full border-collapse text-xs">
                  <thead className="font-mono bg-slate-50 text-[11px] font-semibold uppercase tracking-wide text-slate-500">
                    <tr>
...
function Section({
  ...
  return (
    <section>
      <h3 className="font-mono mb-2 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500">
        {icon}
        {title}
      </h3>
      {children}
