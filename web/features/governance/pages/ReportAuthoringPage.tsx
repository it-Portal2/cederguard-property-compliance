...
import { GovernanceEditor } from '../components/editor/GovernanceEditor';
import { useGovernanceAssets } from '../components/useGovernanceAssets';
import {
  type Amendment,
  type Report,
  type ReportSection,
...
import { RequestAmendmentsModal } from '../components/reports/RequestAmendmentsModal';
...
export function ReportAuthoringPage() {
  ...
  // shared/constants/roleConstants.ts PM_LEVELS. Same gate as the server's
